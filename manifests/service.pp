...
class docker::service (
  ...
  $manage_storage_setup                    = $docker::manage_storage_setup,
  $storage_setup_devs                      = $docker::storage_setup_devs,
  $storage_setup_vg                        = $docker::storage_setup_vg,
  $storage_setup_root_size                 = $docker::storage_setup_root_size,
  $storage_setup_data_size                 = $docker::storage_setup_data_size,
  ...
  if $manage_storage_setup {
    if $::osfamily == 'RedHat' {
      package { 'docker-storage-setup':
        ensure => present,
        notify => Service['docker-storage-setup'],
      }
