# == Class: docker::sysconfig
#
# Class to manage the docker service configuration
#
# === Parameters
# [*tcp_bind*]
...
class docker::sysconfig (
  ...
  unless $::osfamily =~ /(Debian|RedHat|Archlinux|Gentoo)/ {
    fail('The docker::sysconfig class needs a Debian, RedHat, Archlinux or Gentoo based system.')
  }
